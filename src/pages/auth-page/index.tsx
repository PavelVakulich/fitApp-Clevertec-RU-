...
import { useCheckEmailMutation, useLoginMutation } from '@redux/API/authorizeApi';
...
export const AuthPage = () => {
    ...
    const onFinish = async (values: LoginFormValues) => {
        try {
            ...
            dispatch(push(PATHS.LOGIN_ERROR, { fromResult: true }));
        }
    };
        ...
        if (!email) {
            ...
            try {
                ...
                if (
                    ...
                    dispatch(push(PATHS.FORGOT_PASSWORD_ERROR_NO_EMAIL, { fromResult: true }));
                    return;
                }
                dispatch(push(PATHS.FORGOT_PASSWORD_ERROR, { fromResult: true, email: email }));
            }
        }
    ...
    return (
        ...
        >
            ...
            <Form.Item
                name={'password'}
                rules={[{ required: true, message: 'Обязательное поле' }, validatePassword]}
